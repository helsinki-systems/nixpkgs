let
  ...
  let
    is4 = lib.versionAtLeast version "4";
...
in
  self: {
    transmission_3 = self.darwin.apple_sdk_11_0.callPackage generic {
      version = "3.00";
      ...
      inherit (self.darwin.apple_sdk_11_0.frameworks) Foundation;
    };

    transmission_4 = self.darwin.apple_sdk_11_0.callPackage generic {
      version = "4.0.1";
